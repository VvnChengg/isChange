...
import './sharePublished-style.css';
        ...
        <div className='right-section'>
          <div className='flex flex-col py-5 pr-5 pl-2.5 mx-auto mt-36 w-full rounded-3xl bg-sky-600 bg-opacity-80 max-md:mt-10'>
            <div className='button-container'>
              <button className='blue-button' onClick={() => routeChangeToCreate()}>
                <img
                  loading='lazy'
              ...
              <button className='blue-button' onClick={() => routeChangeToEdit()}>
                <img
                  loading='lazy'
              ...
              <button className='blue-button' onClick={() => routeChangeToDelete()}>
                <img
                  loading='lazy'
